...
class ResourcesAnalyzer:
    ...
    def analyze(
        self, name, client_used_refs, app_used_refs, app_packaged_res
    ) -> AnalysisBreakdown:
        ...
        app_used_packaged_res = [
            pr for pr in app_packaged_res if pr.resource in app_used_refs
        ]
        app_unused_packaged_res = [
            pr for pr in app_packaged_res if pr.resource in app_unused_refs
        ]
